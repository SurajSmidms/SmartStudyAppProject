...
fun SubjectScreen(
    ...
    DeleteDialog(
        ...
        bodyText = "Are you sure, you want to delete the subject?",
    ...
    val isFABExplanded by remember {
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            taskList(
                ...
                onCheckBoxClickAction = { onEvent(SubjectEvent.OnTaskIsCompleteChange(it)) }
            )
            item {
