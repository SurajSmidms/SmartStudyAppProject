...
import com.example.smartstudyappproject1.util.TaskCheckBox
import com.example.smartstudyappproject1.util.TaskDatePicker
import com.example.smartstudyappproject1.util.changeMillisToDateString
...
fun TaskScreen(
    ...
    var isDatePicketDialogOpen by rememberSaveable { mutableStateOf(false) }
    ...
    TaskDatePicker(
        ...
        isOpen = isDatePicketDialogOpen,
        onDismissRequest = {isDatePicketDialogOpen = false},
        onConfirmButtonClicked = {
            onEvent(TaskEvent.OnDateChange(millis=datePickerState.selectedDateMillis))
            isDatePicketDialogOpen = false}
    )
    ...
    Scaffold(
        ...
        Column (
            ...
            OutlinedTextField(
                ...
                singleLine = true,
                isError = taskTitleError!=null && state.title.isBlank(),
            ...
            Row(
                ...
                IconButton(onClick = {isDatePicketDialogOpen = true}) {
        ...
        actions = {
            if(isTaskExist){
                TaskCheckBox(
                    ...
                    onCheckBoxClickAction = onCheckBoxClick
                )
